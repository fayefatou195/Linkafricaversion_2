    ...
    <div class="container">
      <div class="head">
        <div class="tableau">
          ...
          <x-nav-link href="{{ route('user.links') }}"  :active="request()->routeIs('user.links')" class="link">
                  {{ __('Links') }}
              </x-nav-link>
        ...
        <div class="imagelogo">
            ...
            <div class="connection">
              <a  href="{{route('login')}}" class="connex">Se connecter</a>
                ...
                <!--<button type="submit" class="inscri">S’inscrire</button>-->
              ...
              <div class="partieB">
                ...
                <div class="cadre1">
                  <div class="zone1">
                    ...
                    <form method="POST" id="settings-form" action="{{ route('user.links') }}">
                      ...
                      @auth
                      <input class="nom" type="text" id="nom" name="nom" placeholder="Entrez un nom" />
                      @endauth
                     ...
                     @endif
                      ...
                      <input class="welcome3" type="url" name="original_url" placeholder="Entrez le lien ici"/>
               ...
               <!--   <input class="form-control-plaintext" id="staticEmail2" type="url" name="original_url" placeholder=""/>-->
                      ...
                      @enderror
                        ...
                        <!--<button type="submit" class="raccour">Raccourcir l’url</button>-->
                          <button class="buttonwelcome3" type="submit">Raccourcir l’url</button>
                        </div>
                       </form>
                 ...
                 <div class="zone3">
                  <div class="cadre2">
                     <!-- <h2 class="lien1">https://www.figma.com/file/vLS9x...</h2>-->
                        ...
                        <input type="text" id="lien_original" class="lien1" value="{{ $original_url }}"  readonly placeholder="original_url">
                     ...
                     <!-- <h2 class="lien2">rb.gy/rtkj7</h2>-->
                      <div>
                        ...
                        <input type="text" id="lien_raccourci" class="lien2" value="{{ $short_url }}" readonly placeholder="short_url">
                      </div>
                      <img src="{{asset("image/Line 4.png")}}" alt="vecteur-ligne" class="ligne">
                      <img src="{{asset("image/Vector.png")}}" alt="vecteursimple" class="vectsimple">
                      <img src="{{asset("image/Line 4.png")}}" alt="vecteur-ligne" class="ligne">
                    <!--  <button type="submit" id="copyButton" data-clipboard-target="#shortLink"  class="lien3">Copier</button>-->
                    <div class="">
                      <button  class="butcopy">
                        <i class="fa-solid fa-copy"></i>
                      </button>
                    </div>
                  </div>
                    <div class="">
                      <button type="submit"  class="butsup">
                        <img src="{{asset("image/Vector (1).png")}}" alt="vecteur-supprimer" class="supprimer"></button>
                     </div>
                  </div>
